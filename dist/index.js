...
const ee = { class: "tasks-box" }, te = { class: "header" }, se = { class: "header-actions" }, oe = ["value"], ae = { class: "tasks-list" }, le = {
  ...
  key: 0,
  class: "edit-mode"
}, me = { class: "task-header-row" }, pe = ["value"], ye = ["id", "onKeyup"], _e = { class: "edit-actions" }, fe = ["onClick"], he = {
  key: 1,
  class: "view-mode"
  ...
  setup(_) {
    const d = _, u = Z(), i = r([]), c = r(null), v = r(""), f = r(""), h = r("medium"), A = r(null), k = r(!1), m = r(""), b = r(""), w = r("medium"), S = r("not_completed"), I = [
      { value: "low", label: "Low", color: "#2196f3" },
      { value: "medium", label: "Medium", color: "#ff9800" },
      { value: "high", label: "High", color: "#f44336" }
    ], U = ["open", "in_progress", "completed", "blocked"], q = Q(() => S.value === "all" ? i.value.filter((o) => !o.archived) : S.value === "not_completed" ? i.value.filter(
      (o) => (o.status === "open" || o.status === "in_progress") && !o.archived
    ) : i.value.filter((o) => o.status === S.value && !o.archived)), z = async () => {
      ...
      c.value = o.id, v.value = o.summary, f.value = o.description || "", h.value = o.priority, await R();
      ...
      if (!e) {
        ...
        t && (t.summary = v.value.trim(), t.description = f.value.trim() || null, t.priority = h.value), c.value = null;
      }
    }, M = () => {
      c.value = null, v.value = "", f.value = "", h.value = "medium";
    }, j = async (o, e) => {
    ...
    return W(() => {
      ...
      s("div", te, [
        e[11] || (e[11] = s("h3", { class: "box-title" }, "Tasks", -1)),
        s("div", se, [
          y(s("select", {
            "onUpdate:modelValue": e[0] || (e[0] = (t) => S.value = t),
            class: "status-filter"
          }, [
            e[8] || (e[8] = s("option", { value: "not_completed" }, "All Not Completed", -1)),
            e[9] || (e[9] = s("option", { value: "all" }, "All Tasks", -1)),
            (n(), l(T, null, x(U, (t) => s("option", {
              key: t,
              value: t
            }, g(B(t)), 9, oe)), 64))
          ], 512), [
      ...
      s("ul", ae, [
        ...
        !k.value && q.value.length === 0 ? (n(), l("li", ue, " No tasks yet. Click the + button to add your first task. ")) : $("", !0),
        (n(!0), l(T, null, x(q.value, (t) => {
          var p;
          return n(), l("li", {
            key: t.id,
            class: P(["task-item", { "task-completed": t.status === "completed" }]),
            onMouseenter: (a) => A.value = t,
            onMouseleave: e[7] || (e[7] = (a) => A.value = null)
          }, [
            s("div", ce, [
              ...
              ((p = A.value) == null ? void 0 : p.id) === t.id && c.value !== t.id ? (n(), l("div", Te, [
                s("button", {
                  onClick: (a) => K(t),
  ...
  for (const [i, c] of d)
    u[i] = c;
  return u;
}, Ve = /* @__PURE__ */ L($e, [["__scopeId", "data-v-9b25c55c"]]), Ae = { class: "tasks-for-single-instrument-view" }, Ie = { class: "boxes-container" }, Ee = /* @__PURE__ */ H({
...
}), qe = /* @__PURE__ */ L(Ee, [["__scopeId", "data-v-41d42e22"]]);
export {
  qe as TasksForSingleInstrument,
  qe as default
};
